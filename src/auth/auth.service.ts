...
export class AuthService {
  ...
  /** Step 1: rider/driver enters their phone number, we text them a 6-digit code. */
  async requestOtp(phone: string) {
    // First login auto-creates the user as a RIDER. Role upgrades to DRIVER
    // happen through a separate, admin-gated onboarding flow — never via self-signup.
